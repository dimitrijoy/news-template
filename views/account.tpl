...
<html lang="en">
	...
	<head>
		...
		<title>{{editor[3]}}'s Account</title>
		<style type="text/css">
	...
	<body>
		...
		<div id="container">
			<div class="account-container">
				<h1>Hello, {{editor[3]}}.</h1>
				<a href="http://localhost:8080/account/upload">Upload articles here.</a>
				<a href="http://localhost:8080/account/edit">Edit articles here.</a>
			</div>
		</div>
		<!-- ACCOUNT END -->
