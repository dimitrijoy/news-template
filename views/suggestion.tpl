			...
			<div class="suggestion-container">
				<div class="suggestion-caption-container">
					<div class="suggestion-caption">
						<h1>Have a suggestion? Leave an anonymous one here.</h1>
					</div>
				</div>
				<div class="form-group">
					<textarea name="suggestion" id="inputSuggestion" class="form-control" form="form" required autofocus></textarea>
				</div>
